...
@section('content')
    <div class="card">
        ...
        @endif
        <form method="post" action="{{route('app.admin.auth.changePassword')}}">
            @csrf 
            @method('put')
            <div class="card-body">
            ...
            <div class="card-footer">
                ...
                <a href="{{route('app.admin.dashbord.index')}}" type="button" class="btn btn-default float-right">Cancel</a>
            </div>
        </form>
    </div>
@stop
